...
Set three dials based on brief inference:
...
## 2. BRIEF -> DESIGN SYSTEM MAP & ARCHITECTURE

- Standardize Tailwind CSS v4, Motion (`framer-motion`), Next.js App Router.
- Mandatory zero em-dashes (U+2014 / U+2013) policy.
- Viewport stability with `min-h-[100dvh]`.
- Hero top padding cap (`pt-24` max), max 2-line headline, subtext max 20 words.
- Max 1 eyebrow per 3 sections.
- Real visual assets and SVG marks.
